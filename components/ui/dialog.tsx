...
>(({ className, children, showClose = true, ...props }, ref) => (
  <DialogPortal>
    ...
    >
      ...
      <div className={cn(
        "glass-large glass-legible rounded-2xl overflow-hidden flex flex-col min-h-0 h-full p-6",
        "glass-dialog-scope"
      )}>
        {children}
      </div>
